...
// 语义分析主类，继承自CACTBaseListener
class SemanticAnalysis : public CACTBaseListener {
private:
    IRGenerator * irGen; // IR生成器
    BlockInfo * globalBlock; // 全局作用域
    BlockInfo * currentBlock; // 当前作用域
    FuncSymbolInfo * currentFunc; // 当前函数
    SymbolInfo * currentSymbol; // 当前符号
    DataType currentDataType; // 当前数据类型
